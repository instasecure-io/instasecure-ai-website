...
// attack showcase and the challenge game. A deliberate subset (~31 of 122); the full catalog
// is private IP. Never expand this to the whole catalog.
export interface RepControl { id: string; name: string; sev: "critical" | "high" | "medium" | "low"; group: string }
